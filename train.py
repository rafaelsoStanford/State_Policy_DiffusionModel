...
def parse_arguments():
    ...
    parser.add_argument('--inpaint_horizon', type=int, default= 2, help='Inpaining horizon, which denotes the amount of steps of our observations to use for inpainting')
